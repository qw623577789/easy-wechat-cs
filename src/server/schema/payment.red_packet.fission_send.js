...
}).required('orderId', 'senderName', 'firstReceiverOpenId', 'money', 'amount', 'wishing')
...
const response = object().properties({
    ...
    .then.required('orderId', 'mchId', 'appId', 'firstReceiverOpenId', 'resultCode', 'money', 'redPacketId', 'sign')
    .else
